...
Java_com_tank3_libtranscode_JNILibTranscode_Init(JNIEnv *env, jclass clazz) {
    int ret = JNI_FALSE;
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_UnInit(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_OpenFFmpegLog(JNIEnv *env, jclass clazz) {
    int ret = JNI_FALSE;
    if (processor) {
        processor->OpenFFLog();
        ret = JNI_TRUE;
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_SetEnableMediaCodec(JNIEnv *env, jclass clazz,
                                                                 jboolean enable) {
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_SetOutputFileDirection(JNIEnv *env, jclass clazz,
                                                                    jstring dir) {
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_SetTranscodeOutputType(JNIEnv *env, jclass clazz,
                                                                    jint out_put_type) {
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_StartTranscode(JNIEnv *env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_com_tank3_libtranscode_JNILibTranscode_StopTranscode(JNIEnv *env, jclass clazz) {
